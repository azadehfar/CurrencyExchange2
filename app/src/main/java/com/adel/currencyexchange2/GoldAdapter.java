...
public class GoldAdapter extends ArrayAdapter<MoneyDataModel> implements View.OnClickListener{
    ...
    public GoldAdapter(ArrayList<MoneyDataModel> data, Context context) {
